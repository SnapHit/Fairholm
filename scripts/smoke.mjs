...
await page.screenshot({ path: '/home/claude/shot-arrival.png' })
...
await page.screenshot({ path: '/home/claude/shot-landed.png' })
...
await page.locator('#bar .btn.primary').tap()
...
for (let i = 0; i < 12; i++) { await page.locator('#bar .btn.primary').tap(); await page.waitForTimeout(60) }
...
await page.screenshot({ path: '/home/claude/shot-midgame.png' })
// 7: save and reload
...
await page.screenshot({ path: '/home/claude/shot-return.png' })
...
await page.waitForTimeout(400)
const land = await page.evaluate(() => ({ landscape: document.getElementById('app').classList.contains('landscape'), canvasW: document.getElementById('map').clientWidth, sheetVisible: document.getElementById('sheet').clientHeight > 100 }))
check('9 portrait and landscape', land.landscape && land.sheetVisible, JSON.stringify(land))
await page.screenshot({ path: '/home/claude/shot-landscape.png' })
